function [] = ObjectCompM(tipo,caminho,taxaAtualizacao)
clear global;
...
% imshow(imagem);
    ...
    fundo=B_atualizado;
    %% Rastrear Objetos
    [caracteristicasAtualizadas,numObjeto]=RastreamentoM (caracteristicasAnt,objetosIdentificadosCont,numObjeto,imagem,taxaAtualizacao);
    caracteristicasAnt=codificadorM(caracteristicasAtualizadas,fundo,imagem,x);
%% Gerar Video
%     pause (0.0000000001);
